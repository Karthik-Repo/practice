...
%>
<label><b>Order Tracking ID : </b></label><label><%=ck.getId()%></label><br>
<label><b>Total Billing Amount : </b></label><label><%=ck.getTotalAmount()%></label>

<h3><label><b>Customer Details :</b></label></h3>
<label><b>Name :</b></label><label><%=ck.getPersonName()%></label><br>
<label><b>Email :</b></label><label><%=ck.getEmail()%></label><br>
<label><b>Mobile :</b></label> <label><%=ck.getContactNumber()%></label><br>
